  ...
  return (
    <div className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 py-12 md:py-24">
      ...
      >
        <div className="flex-1">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-brand-teal/10 border border-brand-teal/20 text-brand-teal text-xs font-semibold mb-6">
            ...
            ANALYSIS COMPLETE
            <span className="ml-2 px-1.5 py-0.5 rounded-full text-brand-cyan text-[10px] uppercase ">Live repository analysis</span>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {/* Item 4: Documentation Readiness */}
        <motion.div
        ...
        >
          <GlassCard className="p-6 h-full border-brand-cyan/20">
        ...
        >
          <GlassCard className="p-6 h-full flex flex-col">
            ...
            <div className="bg-background rounded-lg border border-border p-4 font-mono text-sm overflow-x-auto overflow-y-auto h-[500px]">
        ...
        >
          <GlassCard className="p-6 h-full flex flex-col">
            ...
            <div className="space-y-2 h-[240px] overflow-y-auto pr-1.5 scrollbar-thin">
